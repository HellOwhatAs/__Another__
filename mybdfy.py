...
if os.path.exists("mybdfy_token.mybdfy"):
    with open("mybdfy_token.mybdfy","r") as f:
        token=f.read()
else:
    with open("mybdfy_token.mybdfy","w") as f:
        pass
    raise Exception("please fill the \"mybdfy_token.mybdfy\" with your token in the form")
data={'from': 'en', 'to': 'zh', 'query': 'none', 'transtype': 'realtime', 'simple_means_flag': '3', 'sign': 'none', 'token': 'none', 'domain': 'common'}
